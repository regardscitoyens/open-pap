...
<body>
	...
	<div class="slide" id="slide5" data-slide="5" data-stellar-background-ratio="0.5">
		<div class="container clearfix">
			<div id="content" class="grid_9">
				<h2>Credits</h2>
                                <p>Le projet OpenPAP est un projet du département du livre et de la valorisation des savoir de l'Institut français. Il a été réalisé techniquement réalisé par Regards Citoyens.</p>
